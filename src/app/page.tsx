...
## ۵. جملات انگلیسی در میان متن فارسی (BiDi Auto-Alignment)

سیستم به صورت خودکار جهت و اسکریپت جملات را تشخیص داده و جملات انگلیسی را به زیبایی چپ‌چین (LTR) می‌کند بدون آنکه ساختار پاراگراف یا علائم نگارشی دچار به‌هم‌ریختگی شوند:

### الف) پاراگراف کاملاً انگلیسی (چپ‌چین خودکار):

This is a complete English paragraph embedded inside an RTL document. It is automatically detected as LTR, aligned to the left, and styled cleanly with standard typography.

### ب) جمله انگلیسی به عنوان یک خط مستقل در پاراگراف فارسی:

دستورالعمل راه‌اندازی سرویس به این صورت است:
The development server listens on port 3000 by default.
سپس مرورگر را باز کرده و فرآیند را بررسی کنید.

### ج) جمله انگلیسی درون‌خطی همراه با نقطه و علائم نگارشی:

یکی از شایع‌ترین مشکلات در وب فارسی، جابه‌جا شدن نقطه در پایان جملات انگلیسی است. در این استودیو، The quick brown fox jumps over the lazy dog. دقیقا نقطه در انتهای سمت راست جمله انگلیسی قرار می‌گیرد و متن فارسی بعدی بدون به‌هم‌ریختگی ادامه می‌یابد!

> 💡 **نکته مهم:** حاشیه‌ها و تورفتگی‌ها به شکل اتوماتیک بر مبنای جهت RTL/LTR تنظیم شده‌اند تا حاشیه نقل‌قول در سمت راست و نقل‌قول‌های انگلیسی در سمت چپ قرار گیرند.
`;
